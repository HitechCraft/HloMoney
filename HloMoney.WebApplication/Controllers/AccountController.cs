...
namespace HloMoney.WebApplication.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(IContainer container) : base(container)
        {
        }

        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, IContainer container) : base(container)
        {
